...
export const DE = {
  ...
  '☀️ Sol y sombras': '☀️ Sonne und Schatten',
  'Hora': 'Uhrzeit',
  '☀️ Ver sombras del terreno': '☀️ Geländeschatten anzeigen',
  '☀️ Quitar sombras': '☀️ Schatten entfernen',
  'Proyecta las sombras del DSM a la hora elegida (hoy) — ve qué techos y zonas reciben sol. Requiere un DSM cargado.': 'Projiziert die Schatten des DSM zur gewählten Uhrzeit (heute) — sieh, welche Dächer und Zonen Sonne bekommen. Benötigt ein geladenes DSM.',
  '⚠️ Carga primero un DSM para ver las sombras.': '⚠️ Lade zuerst ein DSM, um die Schatten zu sehen.',
  'sol a': 'Sonne bei',
  'en sombra': 'im Schatten',
  'el sol está bajo el horizonte': 'die Sonne steht unter dem Horizont',
  '📒 Libro de vuelos': '📒 Flugbuch',
  '📒 Importar registro de vuelo (CSV)': '📒 Flugaufzeichnung importieren (CSV)',
  '💾 Exportar libro de vuelos (CSV)': '💾 Flugbuch exportieren (CSV)',
  'Importa el CSV de Airdata/Litchi/registro de vuelo — se dibuja la traza y se registra duración, altura y distancia. Útil como libro de vuelos del operador.': 'Importiere das CSV von Airdata/Litchi/Flugaufzeichnung — die Flugspur wird gezeichnet und Dauer, Höhe und Distanz erfasst. Nützlich als Flugbuch des Betreibers.',
  '⚠️ No se reconoció el CSV. Necesita columnas de latitud, longitud (y tiempo/altura).': '⚠️ CSV nicht erkannt. Es braucht Spalten für Breite, Länge (und Zeit/Höhe).',
  'Vuelo registrado': 'Flug erfasst',
  'máx': 'max',
  'máx despegue': 'max. ab Start',
